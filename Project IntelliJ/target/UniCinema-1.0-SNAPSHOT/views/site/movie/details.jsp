                    ...
                    <div class="col-lg-8 col-md-7 col-12 text-light" id="review-list">
                        ...
                        <form class="collapse mb-4 pb-4" id="collapseReviewBox" novalidate>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="reviewWriteTitle" id="reviewWriteTitle" placeholder="Titolo della recensione" minlength="1" maxlength="50" required>

                                <label for="reviewWriteDescription">Descrizione</label>
                                <textarea class="form-control" name="reviewWriteDescription" id="reviewWriteDescription" rows="3" placeholder="Descrizione della recensione" minlength="1" maxlength="500" required></textarea>
