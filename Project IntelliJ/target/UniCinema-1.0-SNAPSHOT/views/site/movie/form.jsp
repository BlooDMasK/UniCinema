            ...
            <div>
                ...
                <form method="post" action="${pageContext.request.contextPath}/film-manager/${not empty film ? "update" : "add"}" class="needs-validation" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <input name="title" type="text" class="form-control rounded-3 fs-1-5 fw-light" id="title" value="${not empty film ? film.title : ""}" placeholder="Digita un titolo..." required minlength="6" maxlength="50" pattern="^.[^{}\[\];_]{6,50}$">
