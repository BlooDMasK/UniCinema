                ...
                <li class="nav-item">
                    <c:choose>
                        <c:when test="${empty accountSession}">
                            <a class="login-icon nav-link align-self-center" href="${pageContext.request.contextPath}/account/signin"><%@include file="../../../../icons/log-in.svg"%></a>
                        </c:when>
                        <c:otherwise>
                            <div class="dropdown">
                                <a class="login-icon nav-link align-self-center dropdown-toggle" href="${pageContext.request.contextPath}/account/info" data-bs-toggle="dropdown" data-bs-auto-close="true" aria-expanded="false"><%@include file="../../../../icons/person-circle.svg"%></a>
                                <ul class="dropdown-menu rounded-0 bg-light" aria-labelledby="user-icon">
                                    <li class="dropdown-row">
                                        <a class="d-flex flex-row" href="${pageContext.request.contextPath}/account/profile">
                                            <div class="dropdown-icon"><%@include file="../../../../icons/user.svg"%></div>
                                    ...
                                    <li class="dropdown-row">
                                        <a class="d-flex flex-row" href="${pageContext.request.contextPath}/account/profile?edit=1">
                                            <div class="dropdown-icon"><%@include file="../../../../icons/settings.svg"%></div>
                                    ...
                                    <li class="dropdown-row">
                                        <a class="d-flex flex-row" href="${pageContext.request.contextPath}/account/profile?purchases=1">
                                            <div class="dropdown-icon"><%@include file="../../../../icons/chronology.svg"%></div>
                                    ...
                                    <li class="dropdown-row">
                                        <a class="d-flex flex-row" href="${pageContext.request.contextPath}/account/logout">
                                            <div class="dropdown-icon"><%@include file="../../../../icons/log-out.svg"%></div>
